...
if __name__=="__main__":
    ...
    print("Let's play a game of Cows and Bulls!") #explanation
    print("I will generate a number, and you have to guess the numbers one digit at a time.")
    print("if your number is a wrong number or in the wrong position you get a cow and if its in the right place you get a bull.")
    print("The game ends when you get 4 bulls!")
    print("Type exit at any prompt to exit.")
    username = str(input('Input Your name: ')).lower()

    while playing:
        user_guess = input("Guess what number!").lower()
        if user_guess == 'exit':
            print('{}, Thank you for Playing Cows and Bulls'.format(username.capitalize()))
            break
        ...
        elif cowbullcount[1]== 2 or cowbullcount[1]== 3:
            print('{} you are almost there!'.format(username.capitalize()))
        else:
